...
class FinalWindow(QWidget):
    ...
    def initUI(self):
        ...
        self.age_text = QLabel(txt_age + str(self.exp.age))
        self.total_text = QLabel("Total Score: " + str(self.exp.test1 + self.exp.test2 + self.exp.test3))
        
        
        self.layout_line = QVBoxLayout()
        self.layout_line.addWidget(self.index_text, alignment = Qt.AlignCenter)
        self.layout_line.addWidget(self.workh_text, alignment = Qt.AlignCenter)
        self.layout_line.addWidget(self.age_text, alignment = Qt.AlignCenter)
        self.layout_line.addWidget(self.total_text, alignment = Qt.AlignCenter)
